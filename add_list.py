...
created_date =  input('дата начала проекта в формате день-месяц-год: ') # created_date дата начала проекта '13-01-2025' ввод через input
issue_date =  input('дата окончания проекта в формате день-месяц-год: ') # issue_date дата окончания проекта'13-02-2025' ввод через input
